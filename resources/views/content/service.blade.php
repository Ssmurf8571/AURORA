...
<body class="bg-white ">
    ...
    <section class="service-info mt-5 pb-3 mb-4">
        <div class="container position-relative text-center px-0">
                <img class="@if($page!=='trucking') w-100 @endif col-lg-auto col-md-12 col-sm-12 col-12" src="/images/services/{{ $page }}.jpg" alt="">
            <div class="service-overflow"></div>
        </div>
    </section>

    <div class="name-title"><h1 id="raplace" class="text-gray-700 text-capitalize fw-bolder text-center">{{ $page }}</h1><div class="title-border-bottom my-4 mx-auto"></div></div>
