...
<body class="bg-white ">
    @section('page-content')
        <div id="CarouselSlider" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item" style="background: center url('/img/slider/slider_1.jpg');">
                <div class="container">
            ...
            <div class="carousel-item" style="background: center url('/img/slider/slider_2.jpg');">
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1>What exactly is Transloading?</h1>
                        <p>Transloading works for many different types of commoditiess</p>
            ...
            <div class="carousel-item active" style="background: center url('/img/slider/slider_3.jpg');">
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1>What exactly is Transloading?</h1>
                        <p>Transloading works for many different types of commoditiess</p>
        ...
        <section class="cooperate-companies py-5">
            <div class="container">
                ...
                <div class="d-flex flex-md-wrap justify-content-between align-items-center flex-md-row flex-column">
                    <img class="" src="/img/companies/compania-1.webp" alt="">
                    <img class="" src="/img/companies/compania-2.webp" alt="">
                    <img class="" src="/img/companies/compania-3.webp" alt="">
                    <img class="" src="/img/companies/compania-4.webp" alt="">
                    <img class="" src="/img/companies/compania-5.webp" alt="">
                    <img class="" src="/img/companies/compania-6.webp" alt="">
                </div>
            </div>
        </section>
