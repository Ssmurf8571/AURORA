<footer class="bg-dark pt-5 pb-4">
    <div class="container">
        <div class="d-flex flex-wrap justify-content-between">
            ...
            <div class="mb-4 text-white col-lg-3 col-md-6 col-12 px-3">
                <p class="text-uppercase fw-bold text-white">сервисы</p>
                <ul class="ps-0">
                    <li><a class="text-gray-500 text-decoration-none" href="#">Грузоперевозки</a></li>
                    <li><a class="text-gray-500 text-decoration-none" href="#">Рефрижераторы</a></li>
                    <li><a class="text-gray-500 text-decoration-none" href="#">Складирование</a></li>
                    <li><a class="text-gray-500 text-decoration-none" href="#">Специализированная розничная доставка</a></li>
                    <li><a class="text-gray-500 text-decoration-none" href="#">Тяжелая транспортировка</a></li>
                    <li><a class="text-gray-500 text-decoration-none" href="#">Экспресс-доставка</a></li>
                </ul>
            </div>
            <div class="mb-4 text-white col-lg-3 col-md-6 col-12 px-3">
    ...
    <div class="container d-sm-grid text-center text-sm-start">
        ...
        <div class="d-flex justify-content-center justify-content-sm-end align-items-end social">
            ...
            <a class="mx-1" href="https://twitter.com"><i class="fab fa-twitter text-white">twitter</i></a>
